...
public class UserRepository {
	...
	public void update(String password, String firstName, String lastName, String email, String username) throws Exception {
		Connection conn = DBUtils.getConnection();
		PreparedStatement pstmt = conn.prepareStatement("update user set firstName = ?, lastName = ?, password = ?, email = ? where username = ?");
